...
&nbsp;&nbsp;&nbsp;&gt; bashevaluate("tail -n 30 sine_of_thirteen_seventeenth.c");<br> 
&nbsp;&nbsp;&nbsp;#include &lt;mpfr.h&gt;<br> 
&nbsp;&nbsp;&nbsp;<br> 
&nbsp;&nbsp;&nbsp;void<br> 
&nbsp;&nbsp;&nbsp;const_something (mpfr_ptr y, mp_prec_t prec)<br> 
...
&nbsp;&nbsp;&nbsp;&gt; bashevaluate("tail -n -9 constant_code.c");<br> 
&nbsp;&nbsp;&nbsp;void<br> 
...
&nbsp;&nbsp;&nbsp;&gt; implementconstant(euler_gamma^(1/3), "euler.c");<br> 
&nbsp;&nbsp;&nbsp;&gt; bashevaluate("tail -n -17 euler.c");<br> 
&nbsp;&nbsp;&nbsp;void<br> 
&nbsp;&nbsp;&nbsp;const_something (mpfr_ptr y, mp_prec_t prec)<br> 
&nbsp;&nbsp;&nbsp;{<br> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/* Declarations */<br> 
...
<span class="category">See also: </span><?php linkTo("command","implementpoly","implementpoly");?>, <?php linkTo("command","libraryconstant","libraryconstant");?>, <?php linkTo("command","library","library");?>, <?php linkTo("command","function","function");?>, <?php linkTo("command","bashevaluate","bashevaluate");?> 
</div> 
