...
syntactically equal and different from <?php linkTo("command","error","error");?>, @NaN@ and [@NaN@, @NaN]. 
Conversely if <span class="arg">expr1</span> and <span class="arg">expr2</span> are objects that are mathematically 
different and Sollya manages to figure it out, the test returns <?php linkTo("command","false","false");?>. 
...
equal and if it manages to prove it, it returns <?php linkTo("command","true","true");?>, without a warning. In 
the case when <span class="arg">expr1</span> and <span class="arg">expr2</span> are two constant expressions, Sollya will 
...
faithful rounding of the real value, it will return <?php linkTo("command","true","true");?> (with a warning if 
...
returns <?php linkTo("command","false","false");?>. 
...
<?php linkTo("command","autosimplify","autosimplify");?> is set to <?php linkTo("command","on","on");?>, polynomial subexpressions that are 
...
expression 1/10). 
</li><li>Notice that @NaN@, [@NaN, @NaN@] and <?php linkTo("command","error","error");?> share the property that they 
compare not equal to anything, including themselves. This means if a variable 
<span class="arg">a</span> contains @NaN@, [@NaN, @NaN@] or <?php linkTo("command","error","error");?> and whatever the content of 
variable <span class="arg">b</span> is, the test <span class="arg">a</span> <?php linkTo("command","equal","==");?> <span class="arg">b</span> returns <?php linkTo("command","false","false");?>. The standard way of 
testing if <span class="arg">a</span> contains @NaN@, [@NaN@, @NaN@] or <?php linkTo("command","error","error");?> is indeed to check if 
<span class="arg">a</span> <?php linkTo("command","equal","==");?> <span class="arg">a</span> returns false. <?php linkTo("command","error","error");?> can be distinguished from @NaN@ and 
[@NaN@, @NaN@] using the <?php linkTo("command","neq","!=");?> operator. In order to distinguish @NaN@ from 
