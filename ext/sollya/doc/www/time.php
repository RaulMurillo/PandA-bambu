...
&nbsp;&nbsp;&nbsp;7.8429420000000000000000000000000000003140228774323e-2 s were spent<br> 
</div> 
<div class="divExample"> 
<h2 class="category">Example 3: </h2> 
&nbsp;&nbsp;&nbsp;&gt; t = time(bashexecute("sleep 10"));<br> 
&nbsp;&nbsp;&nbsp;&gt; write(~(t-10),"s of execution overhead.\n");<br> 
&nbsp;&nbsp;&nbsp;3.49817700000000000000000000000000079155874788710945e-3s of execution overhead.<br> 
</div> 
<div class="divExample"> 
...
&nbsp;&nbsp;&nbsp;This ratio = 1.3726324294540284382195309171761413410808651617341 should somehow be independent of the type of machine.<br> 
</div> 
</div> 
