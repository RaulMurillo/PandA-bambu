#ifndef Posit2Quire_HPP
#define Posit2Quire_HPP
...
namespace flopoco{
  class Posit2Quire : public Operator {
	public:
		/**
		 ...
		 */
        Posit2Quire(OperatorPtr parentOp, Target* target, int width, int wES, int carry);

		/**
		 * Posit2Quire destructor
		 */
		~Posit2Quire();
