#ifndef POSIIT2UINT_HPP
#define POSIIT2UINT_HPP
...
namespace flopoco{
  class Posit2UInt : public Operator {
	public:
		/**
		 ...
		 */
        Posit2UInt(OperatorPtr parentOp, Target* target, int widthI, int wESI, int widthO, bool trunc_p=false);

		/**
		 * Posit2UInt destructor
		 */
		~Posit2UInt();
