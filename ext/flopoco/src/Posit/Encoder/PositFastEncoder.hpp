#ifndef PositFastEncoder_HPP
#define PositFastEncoder_HPP
...
namespace flopoco
{
	class PositFastEncoder : public Operator
	{
	public:
		/**
		 ...
		 */
		PositFastEncoder(OperatorPtr parentOp, Target *target, int width, int wES);

		/**
		 * PositFastEncoder destructor
		 */
		~PositFastEncoder();
