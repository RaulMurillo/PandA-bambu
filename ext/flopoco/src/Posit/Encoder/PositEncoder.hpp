#ifndef PositEncoder_HPP
#define PositEncoder_HPP
...
namespace flopoco
{
	class PositEncoder : public Operator
	{
	public:
		/**
		 ...
		 */
		PositEncoder(OperatorPtr parentOp, Target *target, int width, int wES);

		/**
		 * PositEncoder destructor
		 */
		~PositEncoder();
