...
namespace flopoco
{
	class PositDiv : public Operator
	{
	public:
		/**
		 ...
		 */
		PositDiv(OperatorPtr parentOp, Target *target, int width, int wES, int iters=0, bool useGoldschmidt=false, float dspOccupationThreshold = 0.0, int LUT_out=10);
