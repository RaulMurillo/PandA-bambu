#ifndef PositFastDecoder_HPP
#define PositFastDecoder_HPP
...
namespace flopoco
{
	class PositFastDecoder : public Operator
	{
	public:
		/**
		 ...
		 */
		PositFastDecoder(OperatorPtr parentOp, Target *target, int width, int wES);

		/**
		 * PositFastDecoder destructor
		 */
		~PositFastDecoder();
