#ifndef PositAssign_HPP
#define PositAssign_HPP
...
namespace flopoco
{
	class PositAssign : public Operator
	{
	public:
		/**
		 ...
		 */
		PositAssign(OperatorPtr parentOp, Target *target, int width, int wES);

		/**
		 * PositAssign destructor
		 */
		~PositAssign();
