#ifndef UINT2POSIT_HPP
#define UINT2POSIT_HPP
...
namespace flopoco{
  class UInt2Posit : public Operator {
	public:
		/**
		 ...
		 */
        UInt2Posit(OperatorPtr parentOp, Target* target, int widthI, int widthO, int wES, bool trunc_p=false);

		/**
		 * UInt2Posit destructor
		 */
		~UInt2Posit();
